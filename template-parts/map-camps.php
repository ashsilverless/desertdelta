	...
	<div class="popup">
		...
		<div class="content">
			...
			<div class="pb2 pt1 pl2 pr2">
				...
				<h2 class="heading heading__sm slide-up">Camp Moremi</h2>
				
				<span>Moremi Game Reserve</span>
				
				<p>Aenean sed maximus ipsum. Praesent ac arcu quis nibh porttitor convallis in sed lorem. </p>
				
				<a class="button" href="http://desert---delta.local/camps/camp-moremi/"><i class="fas fa-campground"></i>Camp Moremi</a>
...
<path class="area-destination" id="chobe" fill="#848484" d="M1088.8,361.6c0,0,1.2-10,2.2-13.2c1.1-3.8,6.3-14.7,6.3-14.7l-2.7,1.3l-3.7-2.7l-3,6
    ...
    H1088.8z"/>
<path class="area-destination" id="moremi" fill="#848484" d="M774.6,684.5l44.2-0.4v-47.4c-3.8,1.8-6.2-2.4-6.2-2.4l-2.1-4.2l-8.6,6.5l-2.1,5.6h-5.1
...
<path class="area-destination" id="makgadikgadi" fill="#848484" d="M1065.1,904.1l-14-1l-3,2l-42.5,2.5l-9.5-11.5l-11-5c0,0-13.7-2.6-17.6-3.5l-28.9-5.3l-25.2,0.9
...
<polygon class="area-destination"  id="savuti" fill="#848484" points="825.8,503.7 828.1,502.5 828.1,499.2 840.7,489.5 843.2,484.5 849.7,485.9 
...
<path class="area-destination" id="okavango" fill="#848484" d="M760.6,774l-10.9,10l-9.2-5.3l-11.4-19.3c0,0-14.7-11.1-16.8-16.7c-1-2.7,1.6-8.7,0.7-11.3
...
<circle id="chobegame" fill="#F6E71B" cx="1105.8" cy="410.3" r="10.3"/>
<circle id="chobesav" fill="#F6E71B" cx="1058" cy="410.3" r="10.3"/>
<circle id="sav" fill="#F6E71B" cx="867.2" cy="517.4" r="10.3"/>
...
<circle id="okav" fill="#F6E71B" cx="677" cy="686.7" r="10.3"/>
<circle id="xug" fill="#F6E71B" cx="629.2" cy="686.7" r="10.3"/>
...
<circle id="moremi" fill="#F6E71B" cx="798.7" cy="738.4" r="10.3"/>
<circle id="xan" fill="#F6E71B" cx="750.8" cy="738.4" r="10.3"/>
<circle id="latau" fill="#F6E71B" cx="961.4" cy="938.5" r="10.3"/>
</svg>
